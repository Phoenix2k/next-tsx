...
describe(pages.home.title, () => {
  const { slug: pageSlug, title: pageTitle, url: pageUrl } = pages.home;
  const { slug: altPageSlug, title: altPageTitle, url: altPageUrl } = pages.about;
